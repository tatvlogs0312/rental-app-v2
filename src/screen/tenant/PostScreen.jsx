...
const PostScreen = ({ navigation }) => {
  ...
  const callSearchPostV2 = async () => {
    ...
    await axios
      ...
      .catch((err) => console.error(JSON.stringify(err)))
      .finally(() => loading.nonLoading());
  };

  return (
    <>
      <LoadingModal modalVisible={loading.loading} />
      <View style={{ flex: 1, marginHorizontal: 10, marginTop: 20, marginBottom: 130, height: heighScreen }}>
        <View>
              ...
              >
                <View style={styles.post} key={post.index}>
                  <View style={{ position: "relative" }}>
                    ...
                    />
                    <Text
                      style={{ position: "absolute", bottom: 0, right: 0, padding: 5, backgroundColor: "grey", borderBottomRightRadius: 10, color: "white" }}
                    >
